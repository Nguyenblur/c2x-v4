module.exports = {
    ...
    async onCall({ api, args, message }) {
      ...
      if (!fs.existsSync('./db/data/card/bgweather.jpg')) {
        let getbg = (await axios.get(`https://i.imgur.com/1Rx88Te.jpg`, { responseType: "arraybuffer" })).data;
        fs.writeFileSync("./db/data/card/bgweather.jpg", Buffer.from(getbg, "utf-8"));
      }
      ...
      const bg = await Canvas.loadImage("./db/data/card/bgweather.jpg");
